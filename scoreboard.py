...
class Scoreboard:
    ...
    def prep_high_score(self):
        ...
        score_str = "{:,} {}".format(rounded_score, self.stats.champion_name)
    ...
    def prep_level(self):
        self.level_image = self.font.render("{} lvl".format(self.stats.level), True, self.text_color,
                                            self.ai_settings.bg_color)

        # Level displaing under the current score
